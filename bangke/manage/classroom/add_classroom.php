...
<link rel="stylesheet" type="text/css" href="add_classroom_files/bootstrap.css">
<link rel="stylesheet" type="text/css" href="add_classroom_files/formBuilder.css">
<link rel="stylesheet" type="text/css" href="add_classroom_files/fullcalendar.css">
<link rel="stylesheet" type="text/css" href="add_classroom_files/consult.css">
<link rel="stylesheet" type="text/css" href="add_classroom_files/component.css">
<link rel="stylesheet" type="text/css" href="add_classroom_files/global.css">
<link rel="stylesheet" type="text/css" href="add_classroom_files/style.css">
<link rel="stylesheet" type="text/css" href="add_classroom_files/jquery_002.css">
<link rel="stylesheet" type="text/css" href="add_classroom_files/jquery-ui.css">

<link rel="stylesheet" type="text/css" href="add_classroom_files/textext_003.css">
<link type="text/css" href="add_classroom_files/textext.css" rel="stylesheet">
<link type="text/css" href="add_classroom_files/textext_002.css" rel="stylesheet">
<link type="text/css" href="add_classroom_files/textext_004.css" rel="stylesheet">

<script type="text/javascript" src="add_classroom_files/jquery-1.js"></script>
<script type="text/javascript" src="add_classroom_files/json2.js"></script>
<script type="text/javascript" src="add_classroom_files/ajaxupload.js"></script>

<link rel="stylesheet" type="text/css" href="add_classroom_files/enjoyhint.css">
<script type="text/javascript" src="add_classroom_files/enjoyhint.js"></script>
<script type="text/javascript" src="add_classroom_files/enjoyhintData.js"></script>
<script type="text/javascript" src="add_classroom_files/sender.js"></script>
<script type="text/javascript" src="add_classroom_files/jquery_003.js"></script>

<script type="text/javascript" src="add_classroom_files/hotkeys.js"></script>
<link rel="stylesheet" type="text/css" href="add_classroom_files/jquery.css">
<script type="text/javascript" src="add_classroom_files/jquery_004.js"></script>
<script type="text/javascript" src="add_classroom_files/jquery_002.js"></script>
<link rel="stylesheet" type="text/css" href="add_classroom_files/default.css"><link rel="stylesheet" type="text/css" href="add_classroom_files/emoji.css">
<style type="text/css">
...
<script type="text/javascript">
    ...
    function helperInitialize(key,callback){
        var key=key||(getFCL('classroom')+'-'+getFCL('index'));
    ...
    function showMsgBox(data){
        ...
        if("index"=='index'&&'classroom'=='Index'){
            return false;
        }
...
<div class="popwin" id="popwin_deleteForm">
    ...
    <div class="popwin_content" style="text-align: center">
        <img class="mgb10" src="add_classroom_files/popwin_eroteme.png">
...
<div class="popwin" id="popwin_box">
    <p class="popwin_title" style="display: block;">新增教室</p>
    <div class="popwin_container">
        <div class="popwin_content" style="min-width: 400px; min-height: 300px;"></div>
    </div>
</div>
...
<div class="leftmenu">
<div class="top_logo"> <img src="add_classroom_files/logo.png"> </div>
...
<div>
	<img src="add_classroom_files/cygn.png">
</div>
...
<div class="main">
    ...
    <a class="navigation_bar" href="http://119.23.230.118/bangke/manage/Index/allFunction" id="allfunc">功能大全</a><span class="navigation_bar">&gt;&gt;</span><a class="navigation_bar" href="http://119.23.230.118/bangke/manage/classroom/index">教室管理</a>
    </div>
    <div class="pos">教室管理 | <a href="javascript:void(0);" class="button btn_blue" onclick="showTboxZone('新增教室','/bangke/manage/classroom/add')" id="addclassroom">添加教室</a><a class="tutorial_btn" href="javascript:void(0)" onclick="tutorial()" id="tutorial_btn">怎么用？</a></div>     
    
    <div class="operate" id="searchZone">
        <div class="left">
            <form method="get" action="/bangke/manage/classroom/index">
                <select name="searchKey" id="searchKey" class="select">
                    <option value="cr_code" selected="selected">编号</option>
                    <option value="cr_name">名称</option>
    ...
    <div class="list">    
    <form action="/bangke/manage/classroom/del" method="post" id="form_do" name="form_do">
...
<script type="text/javascript">
    ...
    function showTboxZone(title,url){
        showTBox(title,url,'400px,300px',"",function(){
    ...
    function tutorial(){
        ...
        var enjoyhint_script_steps = [
          {
            selector:'.right' ,
            description: '欢迎使用教室管理功能，接下来将介绍本模块的基本操作。',
            showNext:true,
            justIntro:true,
            showSkip:true,
          },
          {
            selector:'#addclassroom' ,
            description: '点击此处可以添加教室',
            showNext:true,
            showSkip:true,
            disablecontent:true
          },
          {
            selector:'#searchZone' ,
            description: '此处为查询区域，在此处可以选择查询条件并输入查询关键字查询教室列表',
            showNext:true,
            showSkip:true,
            disablecontent:true
          },
          {
            selector:'#tableSL' ,
            description: '在此处可以浏览教室列表，并对其进行编辑、查看等相关操作',
            showNext:true,
            showSkip:true,
            disablecontent:true,
            bottom:-40
...
<script type="text/javascript" src="add_classroom_files/common.js"></script>
<script type="text/javascript" src="add_classroom_files/frame.js"></script>
<script type="text/javascript" src="add_classroom_files/ajax-submit.js"></script>
<script type="text/javascript" src="add_classroom_files/tinybox.js"></script>
<script type="text/javascript" src="add_classroom_files/jquery.js"></script>
<script src="add_classroom_files/fundebug.js" apikey="2ca67352a86631d611e3ed3fc33596f44bc1c17e9634ad8f6383310baa6be453"></script>

<div class="tmask" id="blackmask" style="z-index: 800; height: 669px; width: 1366px; opacity: 0.7; display: block;"></div><div class="tbox " style="position: absolute; z-index: 900; top: 159.5px; left: 317.5px; opacity: 1; display: block;"><div class="tinner" id="" style="width: 731px; height: auto; background-image: none;"><div class="tcontent" style="display: block;">
    <p class="popwin_title" style="display: block;">新增教室</p>
    <div class="popwin_container">
        <div class="popwin_content" style="min-width: 400px; min-height: 300px;"><style>
    .form dt{
        width:80px;
    }
</style>
<div class="main" style="padding-left:40px;padding-right:40px;padding-bottom:0px;">
    <div class="form">
        <form method="post" id="form_do" name="form_do" action="/bangke/manage/classroom/real_add_classroom.php">
        <dl>
            <dt> 教室编号：</dt>
            <dd>
                <input name="cr_code" placeholder="教室编号(必填)" class="input" maxlength="15" type="text">
            </dd>
            <dt style="margin-left:50px;"> 教室名称：</dt>
            <dd>
                <input name="cr_name" placeholder="教室名称(必填)" class="input" maxlength="15" type="text">
            </dd>
        </dl>
        ...
        <dl>
            <dt> 教室类别：</dt>
            <dd>
                <select class="select" name="cr_style">
            ...
            <dd>
                <select class="select" name="cr_store">
        ...
        <dl>            
            <dt>备注：</dt>
            <dd>
                <textarea name="cr_remark" cols="100" rows="2" maxlength="200" placeholder="备注"></textarea>
            </dd>
        </dl>

        <div style="text-align:center;margin-top:10px;">
            <input class="button btn_blue" value="提 交" type="submit">
