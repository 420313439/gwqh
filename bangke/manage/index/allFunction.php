...
<link rel="stylesheet" type="text/css" href="allFunction_files/bootstrap.css">
<link rel="stylesheet" type="text/css" href="allFunction_files/formBuilder.css">
<link rel="stylesheet" type="text/css" href="allFunction_files/fullcalendar.css">
<link rel="stylesheet" type="text/css" href="allFunction_files/consult.css">
<link rel="stylesheet" type="text/css" href="allFunction_files/component.css">
<link rel="stylesheet" type="text/css" href="allFunction_files/global.css">
<link rel="stylesheet" type="text/css" href="allFunction_files/style.css">
<link rel="stylesheet" type="text/css" href="allFunction_files/jquery_002.css">
<link rel="stylesheet" type="text/css" href="allFunction_files/jquery-ui.css">

<link rel="stylesheet" type="text/css" href="allFunction_files/textext_003.css">
<link type="text/css" href="allFunction_files/textext.css" rel="stylesheet">
<link type="text/css" href="allFunction_files/textext_002.css" rel="stylesheet">
<link type="text/css" href="allFunction_files/textext_004.css" rel="stylesheet">

<script type="text/javascript" src="allFunction_files/jquery-1.js"></script>
<script type="text/javascript" src="allFunction_files/json2.js"></script>
<script type="text/javascript" src="allFunction_files/ajaxupload.js"></script>

<link rel="stylesheet" type="text/css" href="allFunction_files/enjoyhint.css">
<script type="text/javascript" src="allFunction_files/enjoyhint.js"></script>
<script type="text/javascript" src="allFunction_files/enjoyhintData.js"></script>
<script type="text/javascript" src="allFunction_files/sender.js"></script>
<script type="text/javascript" src="allFunction_files/jquery_003.js"></script>

<script type="text/javascript" src="allFunction_files/hotkeys.js"></script>
<link rel="stylesheet" type="text/css" href="allFunction_files/jquery.css">
<script type="text/javascript" src="allFunction_files/jquery_004.js"></script>
<script type="text/javascript" src="allFunction_files/jquery_002.js"></script>
<link rel="stylesheet" type="text/css" href="allFunction_files/default.css"><link rel="stylesheet" type="text/css" href="allFunction_files/emoji.css">
<style type="text/css">
...
<script type="text/javascript">
    ...
    function helperInitialize(key,callback){
        var key=key||(getFCL('Index')+'-'+getFCL('allFunction'));
    ...
    function showMsgBox(data){
        ...
        if("allFunction"=='index'&&'Index'=='Index'){
            return false;
        }
...
<div class="popwin" id="popwin_deleteForm">
    ...
    <div class="popwin_content" style="text-align: center">
        <img class="mgb10" src="allFunction_files/popwin_eroteme.png">
...
<div class="top_head">
    <div class="top_search">
	  ...
	  <div class="top_link">
      <ul>
                <li id="i_self"> 广外琴行1【总店】：你好！&nbsp;<?php if ($_COOKIE['PHPSESSID'] == session_id()) echo $_COOKIE['username']; ?></li>
...
<div class="leftmenu">
<div class="top_logo"> <img src="allFunction_files/logo.png"> </div>
...
<div>
	<img src="allFunction_files/cygn.png">
</div>

<div id="items_usual">
    <ul>
        <li id="allFuncBtn"><a class="hollow_button active" href="http://119.23.230.118/bangke/manage/index/allFunction">功能大全(F1)</a></li>
...
<div class="main">
    <div class="text-center"><span style="color:red;font-size:16px;" id="tips"></span></div>
    
    <div class="stu_info_top">
        <a class="navigation_bar" href="http://119.23.230.118/bangke/Manage/Index/allFunction">功能大全</a>
    </div>

    <div class="span6">
          <div class="widget">
            <div class="widget-header">
                <h3 style="float:left">基础数据管理</h3> 
                <!--
                <h3 style="float:right">
                    <a href="http://119.23.230.118/bangke/Manage/DataImport/index" id="dataImport" style="color:#525252;text-decoration: none;">批量数据导入&gt;&gt;</a>
                </h3>
                -->
            </div>
            <!-- /widget-header -->
            <div class="widget-content">
                <div class="shortcuts"> 
                    <a href="http://119.23.230.118/bangke/manage/student/index.php" class="shortcut" id="student"><span class="shortcut-label">学员管理</span></a>
                    <a href="http://119.23.230.118/bangke/manage/teacher/index.php" class="shortcut" id="teacher"><span class="shortcut-label">老师管理</span></a>
                    <a href="http://119.23.230.118/bangke/manage/salesman/index.php" class="shortcut"><span class="shortcut-label">销售员管理</span></a>
                    <a href="http://119.23.230.118/bangke/manage/store/index.php" class="shortcut" id="store"><span class="shortcut-label">门店管理</span></a>
                </div>
                <!-- /shortcuts --> 
            </div>
            <!-- /widget-content --> 
        ...
        <div class="widget">
            ...
            <div class="widget-content">
                <div class="shortcuts"> 
                    <a href="http://119.23.230.118/bangke/Manage/Teacher/settlement" class="shortcut"><span class="shortcut-label">老师工资结算</span> </a>
                    <a href="http://119.23.230.118/bangke/Manage/Salesman/settlement" class="shortcut"><span class="shortcut-label">销售工资结算</span></a>
                    <a href="http://119.23.230.118/bangke/Manage/Finance/allStatic" class="shortcut"><span class="shortcut-label">财务统计</span> </a>
                    <a href="http://119.23.230.118/bangke/Manage/Finance/in" class="shortcut"><span class="shortcut-label">收支记账</span> </a>
                    <a href="http://119.23.230.118/bangke/Manage/CheckStand/checkStand" class="shortcut"><span class="shortcut-label">收银台</span> </a>
                </div>
                <!-- /shortcuts --> 
            </div>
            <!-- /widget-content --> 
         ...
         <div class="widget">
            ...
            <div class="widget-content">
                <div class="shortcuts"> 
                    <a href="javascript:void(0)" class="shortcut vip vip_func"><span class="shortcut-label">操作日志</span><img class="vip_img" title="VIP用户专享" src="allFunction_files/vip.svg" align="bottom"></a>
                    <a href="http://119.23.230.118/bangke/Manage/Static/course_buy" class="shortcut"><span class="shortcut-label">课程购买记录</span> </a>
                    <a href="http://119.23.230.118/bangke/Manage/Static/service_buy" class="shortcut"><span class="shortcut-label">服务购买记录</span></a>
                    <a href="http://119.23.230.118/bangke/Manage/Static/noticeList" class="shortcut"><span class="shortcut-label">通知记录</span></a>
                    <a href="http://119.23.230.118/bangke/Manage/Static/studentStatic" class="shortcut"><span class="shortcut-label">报<nobr>表<sup style="color:red">beta</sup></nobr></span></a>
                </div>
                <!-- /shortcuts --> 
            </div>
            <!-- /widget-content --> 
     ...
     <div class="span6">
          <div class="widget">
            ...
            <div class="widget-content">
                <div class="shortcuts"> 
                    <a href="http://119.23.230.118/bangke/manage/classroom/index.php" class="shortcut"><span class="shortcut-label">教室管理</span></a>
                     <a href="http://119.23.230.118/bangke/manage/course/index.php" class="shortcut" id="course"><span class="shortcut-label">课程管理</span></a>
                     <a href="http://119.23.230.118/bangke/manage/booking/confirm.php" class="shortcut" id="scheduling"><span class="shortcut-label">班级排课管理</span> </a>
                    <a href="http://119.23.230.118/bangke/manage/index/index" class="shortcut"><span class="shortcut-label">上课签到</span> </a>
                    <a href="http://119.23.230.118/bangke/manage/service/index" class="shortcut"><span class="shortcut-label">服务卡管理<sup style="color:red;">new</sup></span></a>
                </div>
                <!-- /shortcuts --> 
            </div>
            <!-- /widget-content --> 
      ...
      <div class="widget">
        ...
        <div class="widget-content">
            <div class="shortcuts"> 
                <a href="http://119.23.230.118/bangke/Manage/SignUp/index" class="shortcut"><span class="shortcut-label">招生统计</span> </a>
                <a href="http://119.23.230.118/bangke/Manage/SignUp/storecourse" class="shortcut"><span class="shortcut-label">微招生设<nobr>置<sup style="color:red">new</sup></nobr></span></a>
                <a href="http://119.23.230.118/bangke/WeChat/AppMarket/addPoster" class="shortcut"><span class="shortcut-label">招生海报设<nobr>置<sup style="color:red">限时</sup></nobr></span></a>
                <a href="http://119.23.230.118/bangke/Manage/Article/index" class="shortcut"><span class="shortcut-label">文章管<nobr>理<sup style="color:red">new</sup></nobr></span></a>
                            </div>
            <!-- /shortcuts --> 
        </div>
        <!-- /widget-content --> 
        ...
        <div class="widget">
                ...
                <div class="widget-content">
                    <div class="shortcuts"> 
                        <a href="http://119.23.230.118/bangke/Manage/Index/loginSmpss" target="_blank" class="shortcut"><span class="shortcut-label">商品管理系<nobr>统<sup style="color:red">new</sup></nobr></span> </a>
                        <a href="http://119.23.230.118/bangke/Manage/OLStoreGoods/index" class="shortcut"><span class="shortcut-label">微信商<nobr>城<sup style="color:red">new</sup></nobr></span> </a>
                    </div>
                    <!-- /shortcuts --> 
                </div>
                <!-- /widget-content --> 
...
<script type="text/javascript">
    $(function(){
        ...
        var enjoyhint_instance = new EnjoyHint({
          onEnd:function(){
            //do something
            setCookie('is_first',0);
          }});

        /*
        修改源码屏蔽close_btn,添加event_type的stop选项，禁止自动跳转下一条记录
        */

        var enjoyhint_script_steps = enjoyhint_script_preset_steps.noviceGuide.noviceGuide_allfunc;

        if('0'=='0'){
            var steps=[enjoyhint_script_steps[0],enjoyhint_script_steps[1]];
            ...
            var steps=[enjoyhint_script_steps[3]];
            enjoyhint_instance.set(steps);
            enjoyhint_instance.run();
        }else if('1'=='0'){
            var steps=[enjoyhint_script_steps[4]];
            enjoyhint_instance.set(steps);
            enjoyhint_instance.run();
        }else if('0'=='0'&&'0'){
            var steps=[enjoyhint_script_steps[5]];
            enjoyhint_instance.set(steps);
            enjoyhint_instance.run();
        }

        if('0'=='1'&&'0'=='1'&&'0'=='1'&&'1'=='1'&&getCookie('is_first')==1&&'0'>0){
...
<script type="text/javascript" src="allFunction_files/common.js"></script>
<script type="text/javascript" src="allFunction_files/frame.js"></script>
<script type="text/javascript" src="allFunction_files/ajax-submit.js"></script>
<script type="text/javascript" src="allFunction_files/tinybox.js"></script>
<script type="text/javascript" src="allFunction_files/jquery.js"></script>
