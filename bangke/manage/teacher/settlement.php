...
<title>邦客琴行管家</title>
<!--客服固定框css-->
<link rel="icon" href="http://119.23.230.118/bangke/Public/Static/119.23.230.118/main/icon.png" type="image/x-icon">
<link rel="stylesheet" type="text/css" href="settlement_files/bootstrap.css">
<link rel="stylesheet" type="text/css" href="settlement_files/formBuilder.css">
<link rel="stylesheet" type="text/css" href="settlement_files/fullcalendar.css">
<link rel="stylesheet" type="text/css" href="settlement_files/consult.css">
<link rel="stylesheet" type="text/css" href="settlement_files/component.css">
<link rel="stylesheet" type="text/css" href="settlement_files/global.css">
<link rel="stylesheet" type="text/css" href="settlement_files/style.css">
<link rel="stylesheet" type="text/css" href="settlement_files/jquery_002.css">
<link rel="stylesheet" type="text/css" href="settlement_files/jquery-ui.css">

<link rel="stylesheet" type="text/css" href="settlement_files/textext_003.css">
<link type="text/css" href="settlement_files/textext.css" rel="stylesheet">
<link type="text/css" href="settlement_files/textext_002.css" rel="stylesheet">
<link type="text/css" href="settlement_files/textext_004.css" rel="stylesheet">

<script type="text/javascript" src="settlement_files/jquery-1.js"></script>
<script type="text/javascript" src="settlement_files/json2.js"></script>
<script type="text/javascript" src="settlement_files/ajaxupload.js"></script>

<link rel="stylesheet" type="text/css" href="settlement_files/enjoyhint.css">
<script type="text/javascript" src="settlement_files/enjoyhint.js"></script>
<script type="text/javascript" src="settlement_files/enjoyhintData.js"></script>
<script type="text/javascript" src="settlement_files/sender.js"></script>
<script type="text/javascript" src="settlement_files/jquery_003.js"></script>

<script type="text/javascript" src="settlement_files/hotkeys.js"></script>
<link rel="stylesheet" type="text/css" href="settlement_files/jquery.css">
<script type="text/javascript" src="settlement_files/jquery_004.js"></script>
<script type="text/javascript" src="settlement_files/jquery_002.js"></script>
<link rel="stylesheet" type="text/css" href="settlement_files/default.css"><link rel="stylesheet" type="text/css" href="settlement_files/emoji.css">
<style type="text/css">
...
<script type="text/javascript">
        ...
        var showNotification = function(){
            if (Notification.permission == "granted") {
                var _default = {
                    "title":"【邦客】系统消息",
                    "body":"",
                    "icon":"/bangke/Public/Static/119.23.230.118/main/icon.png",
                    "show":true,
                };
    ...
    function helperInitialize(key,callback){
        var key=key||(getFCL('Teacher')+'-'+getFCL('settlement'));
    ...
    function showMsgBox(data){
        ...
        if("settlement"=='index'&&'Teacher'=='Index'){
            return false;
        }
    ...
    function showVip(){
        ...
        $('.vip').each(function(){
            if($(this).find('.vip_img').length==0){
                $(this).append('<img class="vip_img" title="VIP用户专享" align="bottom" src="/bangke/Public/Static/119.23.230.118/icon/vip.svg">');
            }
        });
        //vipFunc
        vipFunc();
...
<div class="popwin" id="popwin_deleteForm">
    ...
    <div class="popwin_content" style="text-align: center">
        <img class="mgb10" src="settlement_files/popwin_eroteme.png">
...
<div class="leftmenu">
<div class="top_logo"> <img src="settlement_files/logo.png"> </div>
<!-- <div class="top_logo" onclick="ToBuySpace()"> <img src="/bangke/Public/Static/119.23.230.118/main/logo1111.png" /><span id="remain_time" style="color:white"></span> </div> -->
<div class="span"></div>
<div class="menu" id="menu">
<div>
	<img src="settlement_files/cygn.png">
</div>
...
<div class="right">
    ...
    <link rel="stylesheet" type="text/css" href="settlement_files/jscal2.css">
    <link rel="stylesheet" type="text/css" href="settlement_files/border-radius.css">
    <link rel="stylesheet" type="text/css" href="settlement_files/win2k.css">
    <script type="text/javascript" src="settlement_files/calendar.js"></script>
    <script type="text/javascript" src="settlement_files/en.js"></script>

<div class="main">
    <div class="stu_info_top">
    <a class="navigation_bar" href="http://119.23.230.118/bangke/Manage/Index/allFunction">功能大全</a><span class="navigation_bar">&gt;&gt;</span><a class="navigation_bar" href="http://119.23.230.118/bangke/Manage/Teacher/settlement">工资结算管理</a>
    </div>
    <div class="pos">结算老师工资 | <a class="button btn_blue" href="http://119.23.230.118/bangke/Manage/Salesman/settlement">结算销售员工资</a><a class="tutorial_btn" href="javascript:void(0)" onclick="tutorial()" id="tutorial_btn">怎么用？</a></div>  

	<div class="form">
		<form method="get" id="form_do" name="form_do" action="/bangke/Manage/Teacher/settlement">
            <div class="input-group" style="width:250px;float:left">
                <span class="input-group-addon" id="basic-addon1">结算月份</span>
                <input class="form-control" aria-describedby="basic-addon1" name="f_date" id="f_date" value="2017-06" onclick="Calendarset(this,'%Y-%m')" type="text">
            </div>
            <div class="input-group" style="width:250px;float:left;margin:0px 20px">
                <span class="input-group-addon" id="basic-addon1">结算门店</span>
                <select name="rs_id" id="teacher_store" class="form-control select" aria-describedby="basic-addon1">
            ...
            <div class="left">
                ...
                <input class="button btn_blue" value="月份工资单" onclick="show_monthPayroll_article('/bangke/Manage/Teacher/monthPayroll/curTime/1496246400','','月份工资单')" type="button">
                <!-- <a href="javascript:void(0)" class="button btn_blue vip vip_func" onclick="click_download('/bangke/Manage/Teacher/exportClassList/curTime/1496246400')">导出上课记录</a> -->
            </div>
	   </form> 
	</div>
    ...
    <div class="list">
        <div class="tableHead">
            未结算列表
        <a class="a_print vip vip_func" href="javascript:void(0)">打印<img class="vip_img" title="VIP用户专享" src="settlement_files/vip.svg" align="bottom"></a></div>
        <table width="100%">
            <tbody><tr id="nosettle" class="">
                <th>门店</th>
                <th>老师ID</th>
                <th>老师编号</th>
                <th>老师姓名</th>
...
<script type="text/javascript">
    ...
    function tutorial(){
        ...
        var enjoyhint_script_steps = [
          {
            selector:'.right' ,
            description: '欢迎使用老师工资结算功能，接下来将介绍本模块的基本操作。',
            showNext:true,
            justIntro:true,
            showSkip:true,
          },
          {
            selector:'#nosettle' ,
            description: '列表显示的是上月所有未结算工资的老师列表，你可以直接点击相应的操作按钮进行结算和查看上课记录',
            showNext:true,
            showSkip:true,
            disablecontent:true,
            bottom:-40
          ...
          {
            selector:'#f_date' ,
            description: '在此处可以选择结算的月份',
            showNext:true,
            showSkip:true,
            disablecontent:true
          },
          {
            selector:'#teacher_store' ,
            description: '在此处可以选择门店进行筛选，筛选结果将显示在未结算列表中',
            showNext:true,
            showSkip:true,
            disablecontent:true
          },
          ...
          {
            selector:'#salarycount' ,
            description: '该区域为工资结算区域，你可以修改白色背景的区域，即扣费一栏',
            showNext:true,
            showSkip:true,
            disablecontent:true,
            left:-10,bottom: -40,
            onBeforeStart:function(){
                $('.tbox .popwin_content').scrollTop($('.tbox .popwin_content')[0].scrollHeight);
            }
          },
          {
            selector:'#note' ,
            description: '此处可以填写备注',
            showNext:true,
            showSkip:true,
            disablecontent:true
          },
          {
            selector:'#salarysubmit' ,
            description: '点击此处即可成功结算老师工资。销售员工资结算与此类似',
            showNext:true,
            showSkip:true,
            disablecontent:true
          },
    ...
    function show_monthPayroll_article(url,content,title) {
        showTBox(title,url,'900px');
    }

    function show_article(url,title,obj) {
        if(obj){
            var hasSelect=$(obj).closest('tr').find('select');
            if(hasSelect.length>0){
                var s_id=hasSelect.val();
                url+="/s_id/"+s_id;
            }else{
                var s_id=$(obj).closest('tr').find('input').val();
                url+="/s_id/"+s_id;
            }
        }
        showTBox(title,url,'900px','',(istutorial?function(){enjoyhint_instance.trigger('next');}:''));
    }

    function click_download(url){
        if(confirm('确定导出上课记录吗？')){
            var form_do = document.getElementById("form_do"); 
            form_do.action=url;
            form_do.submit(); 
            form_do.action="/bangke/Manage/Teacher/settlement";
        }
    }
...
<script type="text/javascript" src="settlement_files/common.js"></script>
<script type="text/javascript" src="settlement_files/frame.js"></script>
<script type="text/javascript" src="settlement_files/ajax-submit.js"></script>
<script type="text/javascript" src="settlement_files/tinybox.js"></script>
<script type="text/javascript" src="settlement_files/jquery.js"></script>
