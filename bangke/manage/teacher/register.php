...
<script type="text/javascript">
    ...
    function helperInitialize(key,callback){
        var key=key||(getFCL('teacher')+'-'+getFCL('index'));
...
<div class="popwin" id="popwin_box">
    <p class="popwin_title" style="display: block;">添加老师</p>
    <div class="popwin_container">
        <div class="popwin_content" style="min-width: 750px; min-height: 0px;"></div>
    </div>
</div>
...
<div class="main">
    <div class="stu_info_top">
        <a class="navigation_bar" href="http://119.23.230.118/bangke/manage/Index/allFunction" id="allfunc">功能大全</a><span class="navigation_bar">&gt;&gt;</span><a class="navigation_bar" href="http://119.23.230.118/bangke/manage/teacher/index">老师管理</a>
    </div>
    <div class="pos">老师列表 | <input class="button btn_blue" onclick="show_teacheradd('/bangke/manage/teacher/add')" id="teacherAdd" value="添加老师" type="button"> | <a class="button btn_blue" href="http://119.23.230.118/bangke/manage/teacher/resignList">离职老师列表</a><a class="tutorial_btn" href="javascript:void(0)" onclick="tutorial()" id="tutorial_btn">怎么用？</a></div>   

    <div class="operate" id="searchtea">
        <div class="left">
            <form method="post" action="/bangke/manage/teacher/index">
                <select name="searchKey" id="searchKey" class="select">
					<option value="tea_name" selected="selected">姓名</option>
                    <option value="tea_card_id">老师编号</option>
                    <option value="tea_style">类型</option>
					<option value="tea_store">所属门店</option>
					<option value="tea_mobile">手机</option>
				</select>
    ...
    <div class="list">    
    <form action="/bangke/manage/teacher/del" method="post" id="form_do" name="form_do">
        <table id="teacherList" width="100%">
            <tbody><tr id="tea_list">
                ...
                <th>操作</th>
			            ...
			            <tr class="tableOprate">
                                    <td colspan="13" style="text-align:center">没有数据</td>            </tr>
        </tbody></table>
    </form>
    </div>
</div>
<div id="dropMoreBox" style="display: none">
    <input name="teaNotBind" value="1" onclick="setCondition(this)" type="checkbox">未绑定微信
</div>
<div class="article_absolute_content" style="display:none">
    <div class="article_absolute_content">
        <form method="post" action="/bangke/manage/SendMessage/sendteacher/batchFlag/1" onsubmit="return SendMsg(this);">
            <dl>
            ...
            <dl>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <div class="send_all_option" style="display: none;">全部老师：<input id="alltrue" name="isAll" value="1" type="radio"><label for="alltrue">是</label><input id="allfalse" name="isAll" value="0" checked="checked" type="radio"><label for="allfalse">否</label><span class="glyphicon glyphicon-info-sign" aria-hidden="true" style="color:#666" title="选择是则给全部老师发送消息"></span></div>
            </dl>               
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        var enjoyhint_script_steps = enjoyhint_script_preset_steps.noviceGuide.noviceGuide_teacher;
        if('0'=='0'){
            isreload=1;
    ...
    //新手教程
    function tutorial(){
        enjoyhint_instance = new EnjoyHint({onEnd:function(){istutorial=0;}});
        var enjoyhint_script_steps = [
          {
            selector:'.right' ,
            description: '欢迎使用老师管理功能，接下来将介绍本模块的基本操作。',
            showNext:true,
            justIntro:true,
            showSkip:true,
          },
          ...
          {
            selector:'#searchtea' ,
            description: '此处为查询区域，在此处可以选择查询条件并输入查询关键字查询老师列表',
            showNext:true,
            showSkip:true,
            disablecontent:true
          },
          {
            selector:'#tea_list' ,
            description: '在此处可以浏览老师列表，并对其进行编辑等相关操作，也可以点击老师姓名进入老师详情页面查看详情',
            showNext:true,
            showSkip:true,
            disablecontent:true,
            bottom:-40
          ...
          {
            selector:'#basicInfo' ,
            description: "此处为老师基本信息编辑区,老师编号、姓名、评分、电话、门店为必填项，基本工资为老师的月基本工资（固定工资）",
            disablecontent:true,
            showNext:true,
            showSkip:true,
            onBeforeStart:function(){
          ...
          {
            selector:'#timeTable' ,
            description: "此处为老师课程结算方式编辑区，老师必须添加相应的课程结算方式，才能被排课。",
            disablecontent:true,
            showNext:true,
            showSkip:true
          },
          {
            selector:'#addclassCountRow' ,
            description: "点击新增课程结算方式",
            event:'click',
            showSkip:true
          },
          {
            selector:'#selectcourse' ,
            description: "首先在该列选择该老师需要添加结算方式的课程",
            disablecontent:true,
            showNext:true,
            showSkip:true,
            top:10,
          ...
          {
            selector:'#class_pay_tea' ,
            description: "然后在该列输入该老师上完一节所选课程的固定收入，可以为零",
            disablecontent:true,
            showNext:true,
            showSkip:true,
            top:10,
          ...
          {
            selector:'#commission' ,
            description: '如果老师的费用需要按学员数收费，那可以在此设置提成比例，该节课的提成=提成比例*单节课程收费*学员数',
            showNext:true,
            showSkip:true,
            disablecontent:true,
            top:10,
...
/*          {
            selector:'#salesman' ,
            description: '点击此处可以进入销售员管理页面，其操作与老师管理类似',
            showNext:true,
            showSkip:true,
            disablecontent:true,
            onBeforeStart:function(){
    ...
    function showSendMsg(type){
        showTBox(type?'群发所有老师':'发送消息','','',$(".article_absolute_content").html(),function(){
            if(type){
    ...
    function SendMsg(obj){
     ...
     function showBindCode(id,mobile,closejs){
        if(mobile==''){
            alert('请先填写老师的手机');
            return;
        }
        TINY.box.show({
            url:"/bangke/manage/BaseData/tempCode/id/"+id+"/type/6",
            width:500,
            height:540,
            fixed:false,
            maskid:'blackmask',
    ...
    function show_teacheradd(url) {
        showTBox('添加老师',url,'750px','','',(isreload?function(){location.reload();}:''));
	}
	
    function show_teacheredit(url) {
        showTBox('编辑老师',url,'750px','',(istutorial?function(){enjoyhint_instance.trigger('next');}:''));
    }
</script>
	</div>    
</div>
...
<div class="enjoyhint enjoyhint-step-1 enjoyhint_hide"><div class="enjoyhint_svg_wrapper enjoyhint_svg_transparent"><svg width="1600" height="801" class="enjoyhint_canvas enjoyhint_svg"><defs><marker id="arrowMarker" viewBox="0 0 36 21" refX="21" refY="10" markerUnits="strokeWidth" orient="auto" markerWidth="16" markerHeight="12"><path style="fill:none; stroke:rgb(255,255,255); stroke-width:2" d="M0,0 c30,11 30,9 0,20"></path></marker></defs><path style="fill:none; stroke:rgb(255,255,255); stroke-width:3" marker-end="url(#arrowMarker)" d="M472.51666259765625,258.21665954589844 Q282.51666259765625,258.21665954589844 282.51666259765625,152.21665954589844" id="enjoyhint_arrpw_line"></path></svg></div><div id="kinetic_container"><div style="position: relative; display: inline-block; width: 1600px; height: 801px;" class="kineticjs-content" role="presentation"><canvas style="padding: 0px; margin: 0px; border: 0px none; background: transparent none repeat scroll 0% 0%; position: absolute; top: 0px; left: 0px; width: 1600px; height: 801px;" width="1600" height="801"></canvas></div></div><canvas id="enj_canvas" width="1600" height="801" class="enjoyhint_canvas"></canvas><div class="enjoyhint_disable_events" style="top: 0px; left: 0px; height: 92.2167px;"></div><div class="enjoyhint_disable_events" style="top: 132.217px; left: 0px; height: 628.783px;"></div><div class="enjoyhint_disable_events" style="top: 0px; left: 0px; width: 232.517px;"></div><div class="enjoyhint_disable_events" style="top: 0px; left: 332.517px;"></div><div class="disable_content enjoyhint_hide"></div><div class="enjoyhint_hide" style="left: 542.517px; top: 368.217px;">跳过</div><div class="enjoyhint_hide" id="next_btn" style="left: 522.517px; top: 368.217px;">下一步</div><div class="enjoyhint_close_btn" style="right: 10px; top: 10px;"></div><div class="enjoy_hint_label" id="enjoyhint_label" style="padding: 15px; top: 242.217px; left: 482.517px;"><span style="color:lightgreen">点击添加老师</span></div></div><div class="tmask" id="blackmask" style="z-index: 800; height: 801px; width: 1600px; opacity: 0.7; display: block;"></div><div class="tbox " style="position: absolute; z-index: 900; top: 93.5px; left: 376px; opacity: 1; display: block;"><div class="tinner" id="" style="width: 848px; height: auto; background-image: none;"><div class="tcontent" style="display: block;">
    <p class="popwin_title" style="display: block;">添加老师<a class="a_print vip vip_func" style="margin-right: 40px;" href="javascript:void(0)">打印<img class="vip_img" title="VIP用户专享" src="register_files/vip.svg" align="bottom"></a></p>
    <div class="popwin_container">
        <div class="popwin_content" style="min-width: 750px; min-height: 0px;"><div class="main" style="padding-left:30px;padding-right:30px;padding-bottom:0px;">
<!--     <div class="pos">添加老师</div> -->
	<div class="form" id="formtea">
		<form method="post" id="form_teaadd" name="form_teaadd" action="real_register.php">
		<dl>
			<dt> 老师编号：</dt>
			<dd>
				<input name="tea_card_id" placeholder="(必填)" class="input" maxlength="20" type="text">
			</dd>
			<dt style="margin-left:50px;"> 姓名：</dt>
			<dd>
				<input name="tea_name" placeholder="(必填)" class="input" maxlength="10" type="text">
			</dd>
		</dl>
		<dl>
            <dt>授课类别：</dt>
            <dd>
                <input name="tea_style" placeholder="如吉他、钢琴等(必填)" class="input" maxlength="50" type="text">
            </dd>
            <dt style="margin-left:50px;">性别：</dt>
			<dd>
				<input name="tea_sex" checked="checked" value="男" type="radio">男
            	<input name="tea_sex" value="女" type="radio">女
			</dd>
		...
		<dl>
			...
			<dt>教学评分：</dt>
			<dd>
				<input name="tea_score" placeholder="(必填)" class="input" maxlength="10" type="text">
			</dd>

			
			<dt style="margin-left:50px;"> 所属门店：</dt>
			<dd>
				<select name="tea_store" class="select" onchange="showstorecourse(this)">
		...
		<dl>
			<dt>老师QQ：</dt>
			<dd>
				<input name="tea_qq" placeholder="老师QQ" class="input" maxlength="20" type="text">				
			</dd>
			<dt style="margin-left:50px;">联系电话：</dt>
			<dd>
				<input name="tea_mobile" placeholder="电话(必填)" class="input" maxlength="15" type="text">
			</dd>
		</dl>
		...
		<dl>
            <dt>微信：</dt>
            <dd>
                <input name="tea_wechat" placeholder="微信(必填)" class="input" maxlength="15" type="text">
            </dd>
			<dt style="margin-left:50px;">基本工资：</dt>
			<dd>
				<input name="tea_salary" value="0" class="input" placeholder="工资(必填)" maxlength="15" type="text">
			</dd>
        ...
        <!--
		<b style="font-size:14px; color:#666; ">课程结算方式：</b>
        -->
		...
		<table id="timeTable">
            <tbody>
                <tr class="">
                	<th>序号</th>
                	<th id="selectcourse">课程</th>
                 <th id="c_pay">课程售价(节)</th>
                 <th id="class_pay_tea" title="单次课给老师的固定费用">每节课固定收入(元) <span class="glyphicon glyphicon-info-sign" aria-hidden="true" style="color:#666"></span></th>
                    <th id="commission" title="单次课的总收入（各签到学员单次课费【即购买单价*所扣课时】之和）分给老师的比例。原价=购买时单价">上课收入提成(%)（原价） <span class="glyphicon glyphicon-info-sign" aria-hidden="true" style="color:#666"></span></th>
                    <th id="commission" title="单次课的总收入（各签到学员单次课费【即购买均价*所扣课时】之和）分给老师的比例。均价=真实价格/(购买数量+赠送数量)">上课收入提成(%)（均价）<span class="glyphicon glyphicon-info-sign" aria-hidden="true" style="color:#666"></span></th>
                    <th id="class_pay_stu" title="单次课每个学员每个课时给老师的固定收入">每个学员固定提成(元)<span class="glyphicon glyphicon-info-sign" aria-hidden="true" style="color:#666"></span></th>
                    <th></th>
                </tr>
                <tr id="model" class="">
           	        <td>1</td>
                    <td>
 			    		<select name="courseid[]" class="select" style="width:100px" onchange="choosecourse(this)">
                            <option value="" selected="selected">选课程</option>
                        </select>
                    </td>
                    <td>
                        <input name="c_pay[]" class="input" value="0" style="width:100px" type="text">
                    </td>
                    <td> 
                        <input name="class_play[]" class="input" value="0" style="width:100px" type="text">
                    </td>
                    <td>
                        <input name="pre_commission[]" class="input" value="0" style="width:100px" type="text">
                    </td>
                    <td>
                        <input name="commission[]" class="input" value="0" style="width:100px" type="text">
                    </td>
                    <td>
                        <input name="per_class_pay[]" class="input" value="0" style="width:100px" type="text">
                    </td>
                    <td>
                        <a href="javascript:void(0)" onclick="deleteRow(this)" style="display:none">删除</a>
                    </td>
                </tr>
            </tbody>
        </table>
        <div style="text-align:center;margin-top:10px;">
            <input class="button btn_blue" style="" value="增加课程结算方式" onclick="addRow()" type="button">
        </div>
        </div>
		<div style="text-align:center;margin-top:10px;">
			<input class="button btn_blue" id="submit" value="提 交" type="submit">
