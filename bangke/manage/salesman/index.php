...
<div class="main">
    ...
    <div class="pos">销售员列表 | <a href="http://119.23.230.118/bangke/manage/salesman/add_salesman.php" class="button btn_blue"  id="addsaleman" type="button">添加销售员</a> | <a class="button btn_blue" href="http://119.23.230.118/bangke/manage/salesman/resignList">离职销售员列表</a> <a class="tutorial_btn" href="javascript:void(0)" onclick="tutorial()" id="tutorial_btn">怎么用？</a></div>   	  

    <div class="operate" id="searchsaleman">
        <div class="left">
            <form method="post" action="/bangke/manage/salesman/index.php">
                <select name="searchKey" id="searchKey" class="select">
					...
					<option value="salesman_store">所属门店</option>
					<option value="salesman_mobile">手机</option>
				</select>
...
if (isset($_POST['submit'])) {
    ...
    if ($search_key == 'salesman_card_id' || $search_key == 'salesman_name' || $search_key == 'salesman_store' || $search_key == 'salesman_mobile')
        $sql = "select salesman_card_id, salesman_name, salesman_score, salesman_sex, salesman_store, salesman_qq, salesman_wechat, salesman_mobile, salesman_salary, salesman_school from salesman_info where ".$search_key." = ?";
    else {
    ...
    mysqli_stmt_bind_result($stmt, $salesman_card_id, $salesman_name, $salesman_score, $salesman_sex, $salesman_store, $salesman_qq, $salesman_wechat, $salesman_mobile, $salesman_salary, $salesman_school);

    while (mysqli_stmt_fetch($stmt)) {
        echo '<tr id="tea_list" class="">';
        echo '<th><input id="check" type="checkbox" style="display: none"></th>';   /* 占位符 */
        echo '<th>'.$salesman_card_id.'</th>';
        echo '<th>'.$salesman_name.'</th>';
        echo '<th>'.$salesman_score.'</th>';
        echo '<th>'.$salesman_sex.'</th>';
        echo '<th>'.$salesman_store.'</th>';
        echo '<th>'.$salesman_qq.'</th>';
        echo '<th>'.$salesman_wechat.'</th>';
        echo '<th>'.$salesman_mobile.'</th>';
        echo '<th>'.$salesman_salary.'</th>';
        echo '<th>'.$salesman_school.'</th>';
        echo '<th></th>';       /* 占位符 */
        echo '</tr>';
    }
...
<script src="index_files/fundebug.js" apikey="2ca67352a86631d611e3ed3fc33596f44bc1c17e9634ad8f6383310baa6be453"></script>
