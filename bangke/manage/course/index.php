...
<link href="index_files/default_002.css" rel="stylesheet"></head>
...
<div id="webMsg_box" style="display:none">
    <div class="interactiveWallBox">
        <div class="headImgDiv">
            <img class="headImg" src="index_files/index.htm" data-src="_HEADIMGURL_" alt="">
        </div>
        <div class="msgDiv">
...
<!-- <script type="text/javascript" src="/bangke/Public/Static/js/editor/kindeditor.js"></script> -->
<script type="text/javascript" src="index_files/kindeditor.js"></script>
<script type="text/javascript" src="index_files/zh_CN.js"></script>
<script type="text/javascript" src="index_files/json2.js"></script>
...
<div class="main">
    ...
    <a class="navigation_bar" href="http://119.23.230.118/bangke/manage/Index/allFunction" id="allfunc">功能大全</a><span class="navigation_bar">&gt;&gt;</span><a class="navigation_bar" href="http://119.23.230.118/bangke/manage/course/index">课程管理</a> <span class="navigation_bar">&gt;&gt;</span>
        <div class="dropdown" style="display:inline-block">
          <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" style="border-color:#fff;font-size:18px;padding:0px;margin-top:-11px" aria-haspopup="true" aria-expanded="true">
            所有门店            <span class="caret"></span>
          </button>
          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                <li><a href="http://119.23.230.118/bangke/manage/course/index/isOnSell/1">所有门店</a></li>
                      </ul>
        </div>
    </div>
    <div class="pos"><span style="float:left">课程列表 | </span><a href="reg_course.php" class="button btn_blue" id="addcourse" style="float:left" type="button">新增课程</a><span style="float:left"> | </span>
        <div style="width:88px;overflow:hidden;border:1px solid  #2c5e8b;padding:0;border-radius:2px;float:left;background: none repeat scroll 0 0 #377fa3;">       
            <select name="group" id="group" class="button btn_blue" autocomplete="off" style="border:0px;font-size:13px;padding:4px;text-align:center;color:white;cursor: pointer;">
				<option value="-1" selected="selected">课程分组</option>
				<option value="0">新增分组</option>
				    		
			</select>
		</div>
		<div id="add_group" style="margin-left:10px;float:left;display:none">
    	    <form action="/bangke/manage/course/addGroup" method="post" onsubmit="return form_ajax(this,1)">
                <input name="group_name" id="add_group_name" class="input" type="text">
                <input value="添加分组" class="button btn_blue" id="btn_group" type="submit">   
            </form>
        </div>      
    ...
    <div id="main_form" class="form" style="margin-bottom: 10px; display:none;">    
        <form method="post" id="form_do_add" action="/bangke/manage/course/add" enctype="multipart/form-data">
           <div id="add_course">
           		<div class="basic_option">
           			...
           			<div class="left add_right">
		        		...
		        		<dl>
		        			...
		        			<dd class="input-div">
	        					<input name="c_style" checked="checked" value="0" type="radio">一对一
	                    		<input name="c_style" value="1" type="radio">一对多	
		                    </dd>
           			...
           			<div class="left add_right">
						...
						<div id="option" style="display:none">
			        		...
			        		<dl>
			        			...
			        			<dd class="input-div">
		        					<input name="c_state" checked="checked" value="0" type="radio">上架
			  	...
			  	<div class="release_option">
				  	...
				  	<div class="left add_right">
						...
						<div id="option" style="display:none">
				            ...
				            <dl>
				            	<dt></dt>
				            	<dd><img src="index_files/index.htm" alt="" id="c_img"></dd>
				            </dl>
				            <dl>
				            	<dt> 课程简介：</dt>
    ...
    <div class="list">    
    <form action="/bangke/manage/course/del" method="post" id="form_do" name="form_do">
        <div class="tableOperate">
            <a href="http://119.23.230.118/bangke/manage/course/index/isOnSell/1/s_id/"><span class="isOnSell" style="color: rgb(90, 175, 232); font-size: 16px; cursor: pointer;">未下架课程</span></a> | <a href="http://119.23.230.118/bangke/manage/course/index/isOnSell/0/s_id/"><span class="isNotOnSell" style="color:#333;font-size:16px;cursor:pointer;">已下架课程</span></a>
        </div>
        <div class="tableContent">
            <table id="coursetable" width="100%">
                <tbody><tr id="courselist" class="">
