...
<link rel="stylesheet" type="text/css" href="add_store_files/bootstrap.css">
<link rel="stylesheet" type="text/css" href="add_store_files/formBuilder.css">
<link rel="stylesheet" type="text/css" href="add_store_files/fullcalendar.css">
<link rel="stylesheet" type="text/css" href="add_store_files/consult.css">
<link rel="stylesheet" type="text/css" href="add_store_files/component.css">
<link rel="stylesheet" type="text/css" href="add_store_files/global.css">
<link rel="stylesheet" type="text/css" href="add_store_files/style.css">
<link rel="stylesheet" type="text/css" href="add_store_files/jquery_002.css">
<link rel="stylesheet" type="text/css" href="add_store_files/jquery-ui.css">

<link rel="stylesheet" type="text/css" href="add_store_files/textext_003.css">
<link type="text/css" href="add_store_files/textext.css" rel="stylesheet">
<link type="text/css" href="add_store_files/textext_002.css" rel="stylesheet">
<link type="text/css" href="add_store_files/textext_004.css" rel="stylesheet">

<script type="text/javascript" src="add_store_files/jquery-1.js"></script>
<script type="text/javascript" src="add_store_files/json2.js"></script>
<script type="text/javascript" src="add_store_files/ajaxupload.js"></script>

<link rel="stylesheet" type="text/css" href="add_store_files/enjoyhint.css">
<script type="text/javascript" src="add_store_files/enjoyhint.js"></script>
<script type="text/javascript" src="add_store_files/enjoyhintData.js"></script>
<script type="text/javascript" src="add_store_files/sender.js"></script>
<script type="text/javascript" src="add_store_files/jquery_003.js"></script>

<script type="text/javascript" src="add_store_files/hotkeys.js"></script>
<link rel="stylesheet" type="text/css" href="add_store_files/jquery.css">
<script type="text/javascript" src="add_store_files/jquery_004.js"></script>
<script type="text/javascript" src="add_store_files/jquery_002.js"></script>
<link rel="stylesheet" type="text/css" href="add_store_files/default.css"><link rel="stylesheet" type="text/css" href="add_store_files/emoji.css">
<style type="text/css">
...
<script type="text/javascript">
    ...
    function helperInitialize(key,callback){
        var key=key||(getFCL('Store')+'-'+getFCL('index'));
...
<div class="popwin" id="popwin_deleteForm">
    ...
    <div class="popwin_content" style="text-align: center">
        <img class="mgb10" src="add_store_files/popwin_eroteme.png">
...
<div class="popwin" id="popwin_box">
    <p class="popwin_title" style="display: block;">添加门店</p>
...
<div class="leftmenu">
<div class="top_logo"> <img src="add_store_files/logo.png"> </div>
...
<div>
	<img src="add_store_files/cygn.png">
</div>
...
<div class="main">
    ...
    <a class="navigation_bar" href="http://119.23.230.118/bangke/manage/Index/allFunction" id="allfunc">功能大全</a><span class="navigation_bar">&gt;&gt;</span><a class="navigation_bar" href="http://119.23.230.118/bangke/manage/Store/index">门店管理</a>
    </div>
    <div class="pos">门店列表 | <a class="button btn_blue" onclick="show_article('/bangke/manage/Store/add')" id="storeAdd">添加门店</a><a class="tutorial_btn" href="javascript:void(0)" onclick="tutorial()" id="tutorial_btn">怎么用？</a></div>     
    
    <div class="operate" id="searchstore">
        <div class="left">
            <form method="get" action="/bangke/manage/Store/index">
                <select name="searchKey" id="searchKey" class="select">
                    <option value="name" selected="selected">门店</option>
                    <option value="city">城市</option>
                    <option value="address">地址</option>
                    <option value="contact">联系人</option>    
                    <option value="phone">门店电话</option>    
    ...
    <div class="list">    
    <form action="/bangke/manage/Store/del" method="post" id="form_do" name="form_do">
        <table id="tableSL" width="100%">
            <tbody><tr id="storelist">
                ...
                <th>操作</th>
			            ...
			            <tr class="tableOprate">
                                    <td colspan="9" style="text-align:center">没有数据</td>            </tr>
        </tbody></table>
    </form>
    </div>
</div>
...
$(function(){
    ...
    function tutorial(){
        ...
        var enjoyhint_script_steps = [
          {
            selector:'.right' ,
            description: '欢迎使用门店管理功能，接下来将介绍本模块的基本操作。',
            showNext:true,
            justIntro:true,
            showSkip:true,
          },
          ...
          },
          {
            ...
            description: '此处为查询区域，在此处可以选择查询条件并输入查询关键字查询门店列表',
            showNext:true,
            showSkip:true,
            disablecontent:true
          },
          {
            selector:'#storelist' ,
            description: '在此处可以浏览门店列表，并对其进行编辑等相关操作，也可以点击门店名称进入门店详情页面查看详情',
            showNext:true,
            showSkip:true,
            disablecontent:true,
            bottom:-40
    ...
    function show_article(url) {
        showTBox('添加门店',url,'750px','',function(){
            g_AjxUploadImg($("#btn_uploadImg"),$("#s_img"),$("#s_picture"),"Store");
        },(isreload?function(){location.reload();}:''));
    }

    function show_store_article(url) {
        showTBox('编辑门店',url,'750px','',function(){
            g_AjxUploadImg($("#btn_uploadImg"),$("#s_img"),$("#s_picture"),"Store");
        });
    }
...
<script type="text/javascript" src="add_store_files/common.js"></script>
<script type="text/javascript" src="add_store_files/frame.js"></script>
<script type="text/javascript" src="add_store_files/ajax-submit.js"></script>
<script type="text/javascript" src="add_store_files/tinybox.js"></script>
<script type="text/javascript" src="add_store_files/jquery.js"></script>
<script src="add_store_files/fundebug.js" apikey="2ca67352a86631d611e3ed3fc33596f44bc1c17e9634ad8f6383310baa6be453"></script>

<div class="tmask" id="blackmask" style="z-index: 800; height: 669px; width: 1366px; opacity: 0.7; display: block;"></div><div class="tbox " style="position: absolute; z-index: 900; top: 53.5px; left: 306.5px; opacity: 1; display: block;"><div class="tinner" id="" style="width: 753px; height: auto; background-image: none;"><div class="tcontent" style="display: block;">
    <p class="popwin_title" style="display: block;">添加门店</p>
    <div class="popwin_container">
        <div class="popwin_content" style="min-width: 750px; min-height: 0px;"><style>
	.form dt{
		width:80px;
	}
</style>
<div class="main" style="padding-left:40px;padding-right:40px;padding-bottom:0px;">
    <!-- <div class="pos">添加门店</div> -->
    <!-- fuck this -->
    <div style="margin-bottom:15px;">
    	可以添加<span style="color:red;font-size:20px">1</span>个门店，
    	已添加<span style="color:red;font-size:20px;"> 0 </span>个门店<a style="margin-left:30px;color:red;font-size:14px" href="javascript:void(0);" onclick="ToBuySpace();">额度不够？点我点我！</a>
    </div>
    <!-- fuck this end -->
	<div class="form">
		<form method="post" id="form_do" name="form_do" action="/bangke/manage/store/real_add_store.php">
		<dl>
			<dt> 门店名称：</dt>
			<dd>
				<input name="store_name" placeholder="门店名称(必填)" class="input" maxlength="15" type="text">
			</dd>
			<dt style="margin-left:50px;"> 城市：</dt>
			<dd>
				<input name="store_city" placeholder="城市(必填)" class="input" maxlength="10" type="text">
			</dd>
		</dl>
		...
		<dl>
            <dt> 门店编号：</dt>
            <dd>
                <input name="store_id" placeholder="门店编号(必填)" class="input" maxlength="10" type="text">
            </dd>
            <dt style="margin-left:50px;"> 门店风采：</dt>
            <dd>
                <input class="button btn_blue" id="btn_uploadImg" data-width="320" data-height="160" value="上传图片" type="button">
            </dd>
			<dd><input name="store_picture" id="s_picture" value="" type="hidden"></dd>
		</dl>
        <!--
		<dl>
			<dt></dt>
			<dd><img src="" alt="" id="s_img"></dd>
		</dl>
        -->
		<dl>			
			<dt>详细地址：</dt>
			<dd>
					<input name="store_address" placeholder="详细地址(必填)" class="input_large" type="text">
					<a class="button btn_blue" href="javascript:void(0)" onclick="showMap('/bangke/manage/Store/showMap')">请定位门店</a>
					<!-- <input type="text" name="s_address" placeholder="详细地址(必填)" class="input_large" value=""/> -->
								<input name="s_geocoder" value="" type="hidden">
			</dd>
		</dl>
		<dl>
			<dt> 邮政编码：</dt>
			<dd>
				<input name="store_zip_code" placeholder="邮政编码(必填)" class="input" maxlength="10" type="text">
			</dd>
			<dt style="margin-left:50px;">门店电话：</dt>
			<dd>
				<input name="store_phone" placeholder="联系电话(必填)" class="input" maxlength="15" type="text">				
			</dd>
		</dl>
		...
		<dl>
			<dt>负责人：</dt>
			<dd>
				<input name="store_contact_name" placeholder="负责人(必填)" class="input" maxlength="10" type="text">
			</dd>
			<dt style="margin-left:50px;">手机号码：</dt>
			<dd>
				<input name="store_contact_mobile" placeholder="手机号码(必填)" class="input" maxlength="15" type="text">
			</dd>
		</dl>
		<dl>
			<dt>门店简介：</dt>
			<dd>
				<textarea name="store_intro" cols="100" rows="2" maxlength="200"></textarea>
			</dd>
		</dl>

		<div style="text-align:center;margin-top:10px;">
			<input class="button btn_blue" id="storesubmit" value="提 交" type="submit" name="submit">
...
</div><div class="tclose"></div></div></div><div style="display: block; position: absolute; overflow: hidden; margin: 0px; padding: 0px; opacity: 0; direction: ltr; z-index: 2147483583; left: 447.5px; top: 232.067px; width: 90px; height: 30px; visibility: hidden;"><input name="userfile" style="position: absolute; right: 0px; margin: 0px; padding: 0px; font-size: 480px; cursor: pointer;" type="file"></div></body></html>